...
// SCENARIO 4: Mixed Urgency - Some urgent, some not
export const mixedUrgencyScenario: ContainerRecommendation[] = [
  {
    id: 1,
    containerNumber: 1,
    orderByDate: format(addDays(today, 3), "MMM dd, yyyy"),
  ...
  },
  {
    id: 2,
    containerNumber: 2,
    orderByDate: format(addDays(today, 6), "MMM dd, yyyy"),
    deliveryDate: format(addDays(today, 51), "MMM dd, yyyy"),
    totalCartons: 72000,
    productCount: 2,
    urgency: "URGENT",
    products: [
  ...
  },
  {
    id: 3,
    containerNumber: 3,
    orderByDate: format(addDays(today, 18), "MMM dd, yyyy"),
    deliveryDate: format(addDays(today, 63), "MMM dd, yyyy"),
    totalCartons: 55000,
    productCount: 1,
    urgency: null,
    products: [
      {
        ...
        weeklyConsumption: 1600,
        recommendedQuantity: 55000,
        afterDeliveryStock: 67800,
        weeksSupply: 42.4,
        runsOutDate: format(addDays(today, 56), "MMM dd, yyyy"),
      },
    ],
  },
  {
    ...
    products: [
      {
        ...
        afterDeliveryStock: 64000,
        weeksSupply: 67.4,
        runsOutDate: format(addDays(today, 140), "MMM dd, yyyy"),
      },
    ],
  },
];
...
export const SCENARIOS = {
  ...
  mixed: {
    containers: mixedUrgencyScenario,
    products: [], // Will use default mock products
  },
  production: {
    containers: [], // Production uses real data
    products: [], // Production uses real data
  },
};
